...
<?php 
				...
				// 	echo "<td>
				// 		<img alt='testing' src='barcode.php?codetype=code128b&size=55&text=".$row['PRODUCT_ID'].$food.$row['PRICE'].$month." ".$year."&print=true'/>
				...
				// 					echo "<center><img alt='testing' src='barcode.php?codetype=code128b&size=55&text=".$row['M_ID'].$clot.$row['SIZE'].$row['PRICE']."&print=true'/></center>";
