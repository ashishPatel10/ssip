...
<body>
	...
	<div class="title">
		...
		<table>
			<tr>
			<td><label>select the Brand</label></td>
			<td>
			...
			<tr>
			<td><label>select the size</label></td>
			<td>
			...
			?>
			<?php
				$sql1=mysqli_query($conn,"select distinct size from female");
		...
		<table>
			...
			<tr>
			<td><label>select the weight</label></td>
			<td>
